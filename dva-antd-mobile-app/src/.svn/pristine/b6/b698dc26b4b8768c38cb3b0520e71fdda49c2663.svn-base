...
class App extends React.Component {
    ...
    render() {
        ...
        const row = (rowData, sectionID, rowID) => {
            ...
            return (
                <div key={ rowID } style={ { padding: '0 0.3rem', backgroundColor: 'white', } }>
                  ...
                  <div style={ { display: '-webkit-box', display: 'flex', padding: '0.3rem' } }>
                    ...
                    <div style={ { display: 'inline-block' } }>
                      <div style={ { marginBottom: '0.16rem', color: '#000', fontSize: '0.32rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '5rem' } }>
                        { obj.des }-
                        { rowData }
                      </div>
                      <div style={ { fontSize: '0.32rem' } }>
                        <span style={ { fontSize: '0.6rem', color: '#FF6E27' } }>{ rowID }</span> 元/任务
                      </div>
                    </div>
                  </div>
                </div>
        ...
        return (
            <ListView
                      ...
                      refreshControl={ <RefreshControl refreshing={ this.state.refreshing } onRefresh={ this.onRefresh } icon={ this.renderCustomIcon() } /> }
