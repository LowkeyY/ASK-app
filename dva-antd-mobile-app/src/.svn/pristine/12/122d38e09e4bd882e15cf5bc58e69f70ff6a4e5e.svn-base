...
class Loreinfo extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleItemClick = () =>{
    this.props.dispatch(routerRedux.push({pathname:"/librarydetails"}))
  };
        ...
        return (
          ...
          >
            ...
            <div className={"content"}>
              <div>
                <Icon type="info-circle" size="xs" /><span>{obj.views || 0}</span>
              </div>
              <div>
                <Icon type={getLocalIcon("/page/下载.svg")} size="xs" />
                <span>{obj.downs || 0}</span>
              </div>
              <Tag>
