...
const BLOCK_TYPES = [
  ...
  { label:  <Icon type={getLocalIcon('/editor/blockquote.svg')}/>, style: 'blockquote' },
  { label: <Icon type={getLocalIcon('/editor/alignleft.svg')}/>, style: 'left' },
  { label: <Icon type={getLocalIcon('/editor/middle.svg')}/>, style: 'center' },
