...
// http://img.baidu.com/hi/face/i_f13.gif
  ...
  return(
    <div className={styles['RichEditor-emjoy-box']} style={{display:props.isShowEmojiBox?"block":'none'}}>
      <ul>
        {
          arr.map((data,i)=>{
            return <li onClick={props.insertEmoji.bind(null,`${BASE_URL}face/${SmilmgName}${i<9?`0${i+1}`:i+1}.gif`)}><img src={`${BASE_URL}face/${SmilmgName}${i<9?`0${i+1}`:i+1}.gif`}/></li>
          })
