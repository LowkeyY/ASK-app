    ...
    return (
      <div className={styles[`${PrefixCls}-container`]}>
        <div className={styles[`${PrefixCls}-container-head`]} >
          ...
          {
            hotwords.slice(0,3).map(_ => <Hottag {..._} dispatch = {this.props.dispatch}/>)
          }
          <div
        ...
        <div
          ...
          {
            hotwords.slice(3,7).map(_ => <Hottag {..._} dispatch = {this.props.dispatch}/>)
          }
        </div>
        <div
          ...
          {
            hotwords.slice(7).map(_ =><Hottag {..._} dispatch = {this.props.dispatch}/>)
          }
        </div>
      </div>
    );
